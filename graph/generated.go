...
func (ec *executionContext) field_Mutation_createJobListing_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNCreateJobListingInput2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐCreateJobListingInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_updateJobListing_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["id"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐUpdateJobListingInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg1
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNJobListing2ᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListing,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_deleteJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNDeleteJobResponse2ᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐDeleteJobResponse,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_jobs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNJobListing2ᚕᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListingᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v any) (model.CreateJobListingInput, error) {
	res, err := ec.unmarshalInputCreateJobListingInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteJobResponse2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteJobResponse) graphql.Marshaler {
	return ec._DeleteJobResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteJobResponse2ᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteJobResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
	return ec._JobListing(ctx, sel, &v)
}

func (ec *executionContext) marshalNJobListing2ᚕᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.JobListing) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJobListing2ᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNJobListing2ᚖgithubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v *model.JobListing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋdohaᚑmsᚋgoᚑgraphqlᚑmongodbᚑcrudᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v any) (model.UpdateJobListingInput, error) {
